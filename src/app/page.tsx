          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h1 className="text-5xl lg:text-7xl font-light text-gray-900 mb-8 leading-tight">
                Wes Øf
                <span className="block text-primary font-medium mt-2">Rappeur, Artiste</span>
              </h1>
            </motion.div>
            ...
            >
              Je suis Wes Øf, un rappeur engagé Niçois. Je rap et chante sur les themes de la persévérance, le travail et l\\'engagement. Je suis aussi passionné de design et technologie, ce qui me permet de toucher un peu a tout. J\\'aimerai créer un landing page pour me présenter mais aussi partager mes divers liens des réseaux sociaux et stream.
            </motion.p>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-light mb-4">Wes Øf</h2>
            <p className="text-gray-400 mb-8">Rappeur, Artiste</p>
            <div className="pt-8 border-t border-gray-800">
              <p className="text-gray-500">&copy; 2025 Wes Øf. Tous droits réservés.</p>
            </div>
          </div>
        </div>
      </footer>
